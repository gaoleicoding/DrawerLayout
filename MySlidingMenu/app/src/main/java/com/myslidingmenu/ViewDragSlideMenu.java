...
public class ViewDragSlideMenu extends ViewGroup {
    ...
    public OnMenuSlideListener onMenuSlideListener;
    ...
    public ViewDragSlideMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
